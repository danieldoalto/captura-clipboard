...
4. **Selecionar e Salvar**:
   ...
   * **Salvar**:
     * **Salvar Imagens**: Se a opção "Criar arquivo ZIP" estiver desmarcada, as imagens selecionadas serão salvas individualmente na pasta escolhida.
     * **Salvar ZIP**: Se a opção "Criar arquivo ZIP" estiver marcada, um único arquivo `.zip` contendo todas as imagens selecionadas será criado na pasta escolhida.
5. **Limpar**: O botão "Limpar" remove todas as imagens capturadas da sessão atual.
